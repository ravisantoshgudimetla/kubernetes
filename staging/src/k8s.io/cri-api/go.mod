...
replace github.com/golang/mock => github.com/golang/mock v1.4.1

replace github.com/google/btree => github.com/google/btree v1.0.0

replace github.com/google/cadvisor => github.com/google/cadvisor v0.38.5
...
replace github.com/onsi/ginkgo => github.com/openshift/ginkgo v4.5.0-origin.1+incompatible
...
replace github.com/openshift/api => github.com/openshift/api v0.0.0-20201214114959-164a2fb63b5f

replace github.com/openshift/apiserver-library-go => github.com/openshift/apiserver-library-go v0.0.0-20210216185127-6e5216cd541f

replace github.com/openshift/client-go => github.com/openshift/client-go v0.0.0-20201214125552-e615e336eb49

replace github.com/openshift/library-go => github.com/openshift/library-go v0.0.0-20210223155927-2d5e9a25578e
...
replace golang.org/x/crypto => golang.org/x/crypto v0.0.0-20201002170205-7f63de1d35b0
...
replace golang.org/x/tools => golang.org/x/tools v0.0.0-20200616133436-c1934b75d054
...
replace github.com/certifi/gocertifi => github.com/certifi/gocertifi v0.0.0-20180905225744-ee1a9a0726d2
...
replace github.com/docker/go-metrics => github.com/docker/go-metrics v0.0.1

replace github.com/docker/libnetwork => github.com/docker/libnetwork v0.0.0-20190731215715-7f13a5c99f4b

replace github.com/docker/libtrust => github.com/docker/libtrust v0.0.0-20160708172513-aabc10ec26b7
...
replace github.com/fsouza/go-dockerclient => github.com/fsouza/go-dockerclient v0.0.0-20171004212419-da3951ba2e9e

replace github.com/fvbommel/sortorder => github.com/fvbommel/sortorder v1.0.1

replace github.com/getsentry/raven-go => github.com/getsentry/raven-go v0.0.0-20190513200303-c977f96e1095
...
replace github.com/gobuffalo/flect => github.com/gobuffalo/flect v0.2.0
...
replace github.com/gonum/blas => github.com/gonum/blas v0.0.0-20181208220705-f22b278b28ac

replace github.com/gonum/floats => github.com/gonum/floats v0.0.0-20181209220543-c233463c7e82

replace github.com/gonum/graph => github.com/gonum/graph v0.0.0-20170401004347-50b27dea7ebb

replace github.com/gonum/internal => github.com/gonum/internal v0.0.0-20181124074243-f884aa714029

replace github.com/gonum/lapack => github.com/gonum/lapack v0.0.0-20181123203213-e4cdc5a0bff9

replace github.com/gonum/matrix => github.com/gonum/matrix v0.0.0-20181209220409-c518dec07be9
...
replace github.com/openshift/build-machinery-go => github.com/openshift/build-machinery-go v0.0.0-20200917070002-f171684f77ab
...
replace github.com/pkg/profile => github.com/pkg/profile v1.3.0
...
replace github.com/yuin/goldmark => github.com/yuin/goldmark v1.1.27
...
replace golang.org/x/exp => golang.org/x/exp v0.0.0-20200224162631-6cc2880d07d6
...
replace gopkg.in/ldap.v2 => gopkg.in/ldap.v2 v2.5.1
...
replace rsc.io/quote/v3 => rsc.io/quote/v3 v3.1.0

replace rsc.io/sampler => rsc.io/sampler v1.3.0

replace sigs.k8s.io/apiserver-network-proxy/konnectivity-client => sigs.k8s.io/apiserver-network-proxy/konnectivity-client v0.0.14

replace sigs.k8s.io/controller-tools => sigs.k8s.io/controller-tools v0.2.8

replace sigs.k8s.io/kube-storage-version-migrator => sigs.k8s.io/kube-storage-version-migrator v0.0.3

replace sigs.k8s.io/kustomize => sigs.k8s.io/kustomize v2.0.3+incompatible

replace sigs.k8s.io/structured-merge-diff/v4 => sigs.k8s.io/structured-merge-diff/v4 v4.0.2

replace vbom.ml/util => vbom.ml/util v0.0.0-20180919145318-efcd4e0f9787
